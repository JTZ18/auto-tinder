...
class tinderAPI():
    ...
    def nearby_persons(self):
        data = requests.get(TINDER_URL + "/v2/recs/core?locale=en-GB", headers={"X-Auth-Token": self._token}).json()
...
if __name__ == "__main__":
    token = "75b59b6b-4cbb-4afc-bbd6-8dfea7e87c47"
    api = tinderAPI(token)
